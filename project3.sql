...
-- ex4
SELECT * FROM (SELECT *,DENSE_RANK () OVER (PARTITION BY year_id ORDER BY revenue) AS RANK
...
(segment Varchar, scores Varchar)
...
segmentation_score AS (SELECT customername,
